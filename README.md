...
```sh
curl -X POST -H "Content-Type: application/json" -d@testdata/alert_post_body_1.json http://localhost:8081/alerts/alertmanager
```

```sh
curl -X POST -H "Content-Type: application/json" -d@testdata/event-part1.json http://localhost:8081/events/mdai
curl -X POST -H "Content-Type: application/json" -d@testdata/event-part2.json http://localhost:8081/events/mdai
